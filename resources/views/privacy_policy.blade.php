@extends('root.root')
@section('title', __('privacy-policy.head_title'))
@section('content')
    ...
    <div class="container-wrap">
        <section class="privacy-policy-section">
            ...
            <h2>Drem Land Child Care Center Privacy Policy</h2>
            <p class="body-font">
                Last Updated on 11/4/19. This privacy policy is
        ...
        <section class="privacy-policy-section">
            <h3>Introduction</h3>
            <p class="body-font">
                At Galaxy Kids Academy, we respect your privacy and are
            ...
            <p class="body-font">
                ...
                this website (our “Website”) and our practices for
            ...
            <ul class="policy-list body-font">
            ...
            <p class="body-font">
                ...
                to time. Your continued use of this Website after we
        ...
        <section class="privacy-policy-section">
            ...
            <p class="body-font">
                ...
                on this Website or on or through any of its
                features/register on the Website, make any purchases
                through the Website, use any of the interactive or
                public comment features of this Website or provide any
                information about yourself to us, including your name,
                address, telephone number, e-mail address or any screen
                ...
                please contact us via our contact us link.
            </p>
        </section>
        ...
        <section class="privacy-policy-section">
            ...
            <ul class="policy-list body-font">
                <li>
                    ...
                    name, postal address, e-mail address, telephone
                    number or ANY OTHER INFORMATION THE WEBSITE COLLECTS
                    THAT IS DEFINED AS PERSONAL OR PERSONALLY
            ...
            <p class="body-font">We collect this information:</p>
            <ul class="policy-list body-font">
        ...
        <section class="privacy-policy-section">
            ...
            <ul class="policy-list body-font">
                <li>
                    ...
                    our Website. This includes information provided at
                    the time of registering to use our Website,
                    subscribing to our service, posting material or
                    requesting further services. We may also ask you for
                    information when you report a problem with our
                    Website.
                </li>
                <li>
                    Records and copies of your correspondence (including
                    e-mail addresses), if you contact us.
                </li>
                <li>
                ...
                <li>
                    ...
                    Website and of the fulfillment of your orders. You
                    may be required to provide financial information
            ...
            <p class="body-font">
                ...
                User Contributions are posted on and transmitted to
                others at your own risk. Although we limit access to
                certain pages/you may set certain privacy settings for
                such information by logging into your account profile,
                please be aware that no security measures are perfect or
                impenetrable. Additionally, we cannot control the
                actions of other users of the Website with whom you may
                choose to share your User Contributions. Therefore, we
                cannot and do not guarantee that your User Contributions
        ...
        <section class="privacy-policy-section">
            ...
            <ul class="policy-list body-font">
                <li>
                    ...
                    traffic data, location data, and other communication
                    data and the resources that you access and use on
                    the Website.
                </li>
                <li>
            ...
            <p class="body-font">
                ...
                (behavioral tracking). The information we collect
                automatically is statistical data and does not include
                personal information, but we may maintain it or
            ...
            <ul class="policy-list body-font">
                ...
                <li>
                    ...
                    us to customize our Website according to your
            ...
            <ul class="policy-list body-font">
                ...
                <li>
                    ...
                    as are used for browser cookies.
                </li>
                <li>
                    Web Beacons. Pages of our the Website may contain
                    small electronic files known as web beacons (also
                    ...
                    certain website content and verifying system and
                    server integrity).
                </li>
            </ul>
            <p class="body-font">
        ...
        <section class="privacy-policy-section">
            ...
            <ul class="policy-list body-font">
                ...
                <li>
                    ...
                    of the Company’s assets, whether as a going concern
                    or as part of bankruptcy, liquidation or similar
                    proceeding, in which personal information held by
                    the Company about our Website users is among the
                    assets transferred.
                </li>
                <li>
                    To third parties to market their products or
                    services to you if you have consented to these
                    disclosures. We contractually require these third
                    parties to keep personal information confidential
                    and use it only for the purposes for which we
                    disclose it to them.
                </li>
                <li>
                    To fulfill the purpose for which you provide it. For
                    example, if you give us an e-mail address to use the
                    “e-mail a friend” feature of our Website, we will
                    transmit the contents of that e-mail and your e-mail
            ...
            <ul class="policy-list body-font">
                ...
                <li>
                    ...
                    Company, our customers or others. This includes
        ...
        <section class="privacy-policy-section">
            ...
            <ul class="policy-list body-font">
                <li>
                    ...
                    or to alert you when cookies are being sent. To
                    learn how you can manage your Flash cookie settings,
                    visit the Flash player settings page on Adobe’s
                    website. If you disable or refuse cookies, please
                    note that some parts of this site may then be
                    inaccessible or not function properly.
                </li>
                <li>
                    We do not control third parties’ collection or use
                    of your information to serve interest-based
                    advertising. However these third parties may provide
                    you with ways to choose not to have your information
                    collected or used in this way. You can opt out of
                    receiving targeted ads from members of the Network
        ...
        <section class="privacy-policy-section">
            ...
            <p class="body-font">
                You may send us an e-mail via our contact link to
        ...
        <section class="privacy-policy-section">
            ...
            <p class="body-font">
                ...
                notify you by e-mail to the e-mail address specified in
                your account and/or through a notice on the Website home
                page. The date the privacy policy was last revised is
                identified at the top of the page. You are responsible
                for ensuring we have an up-to-date active and
                deliverable e-mail address for you, and for periodically
                visiting our Website and this privacy policy to check
                for any changes.
            </p>
        </section>
        <section class="privacy-policy-section">
            ...
            <p class="body-font">
                ...
                and our privacy practices, contact via our Contact Us
                link.
            </p>
            <p class="body-font">Thank You for Visiting the Website.</p>
        </section>
