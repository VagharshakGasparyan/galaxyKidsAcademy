...
//        dd($request->all());
        request()->validate([
            ...
            'image' => 'nullable|image|mimes:jpeg,png,jpg|max:2048|dimensions:min_width=96,min_height=96,max_width=1920,max_height=1920',
            'images' => 'nullable|array|min:1|max:50',
            'images.*' => 'required|image|mimes:jpeg,png,jpg|max:2048|dimensions:min_width=96,min_height=96,max_width=1920,max_height=1920',
        ]);
    ...
    public function update($id): \Illuminate\Contracts\View\View
    {
        ...
        return view('admin.page.update_page');
    }

    public function postUpdate(Request $request, $id): \Illuminate\Http\RedirectResponse
    {
        request()->validate([]);
        return redirect()->route('admin.pages');
    }
